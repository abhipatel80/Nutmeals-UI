...
const TermsConditions = () => {
  return (
    <div className="flex justify-center items-start flex-col max-w-full p-4">
      <h2 className="text-2xl font-bold mb-2">Privacy Policy</h2>
      <p className="mb-2">Last updated: April 13, 2024</p>
      <p className="mb-2">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          'Us', or 'Our' in this Agreement) refers to J B Enterprise, 34, GF,
          Satyam Mall, Opp Samaan Complex, Near Mansi Circle.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>Website</strong> refers to J B Enterprise, accessible from{" "}
          <a
            href="https://www.nutmeals.com"
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li className="mb-2">
          ...
          <a
            href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objectsflash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_"
            rel="external nofollow noopener noreferrer"
            target="_blank"
            className="text-blue-500 hover:underline"
          >
      ...
      <ul className="mb-2">
        <li>By email: hellonutmeals@gmail.com</li>
      </ul>
    </div>
  );
};
